defmodule Advent2019.CLI do
  def main(argv) do
    ...
    case day do
      ...
      "7" ->
        IO.inspect(Advent2019.Seven.main("input_seven.txt"))

      "7.2" ->
        IO.inspect(Advent2019.Seven.main2("input_seven.txt"))

      "8" ->
        IO.inspect(Advent2019.Eight.main("input_eight.txt"))

      "9" ->
        IO.inspect(Advent2019.Nine.main("input_nine.txt"))
